#include "Window.h"
#include "details/DefaultProperties.inc"
...
namespace Harmony
{
    ...
    void RaylibWindow::onInitialize(const Properties& properties)
    {
            ...
            const std::string& propertyName) -> T
        {
            ...
            m_logger->warn("RaylibWindow '{}': Property '{}' not found; using default value.", GET_NAME(), propertyName);
            return defaultValue;
        };
        ...
        m_logger->info("RaylibWindow '{}': Creating window with dimensions {}x{} and title '{}'.",
                       GET_NAME(), windowWidth, windowHeight, windowTitle);

        InitWindow(windowWidth, windowHeight, windowTitle.c_str());
        setVSync(vsyncEnabled);

        m_logger->info("RaylibWindow '{}': Window created successfully. VSync: {}.", GET_NAME(), vsyncEnabled ? "enabled" : "disabled");
    }
    ...
    void RaylibWindow::onEvent()
    {
        ...
        if (WindowShouldClose()) {
            m_logger->info("RaylibWindow '{}' of type '{}': Window close event detected; signaling engine shutdown.", GET_NAME(), GET_TYPE());
        }
    }
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': close() called.", GET_NAME());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting width to {}.", GET_NAME(), width);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting height to {}.", GET_NAME(), height);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting size to {}x{}.", GET_NAME(), width, height);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting minimum size to {}x{}.", GET_NAME(), width, height);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting maximum size to {}x{}.", GET_NAME(), width, height);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting position to ({}, {}).", GET_NAME(), x, y);
    ...
    void RaylibWindow::centerWindow()
    {
        ...
        m_logger->trace("RaylibWindow '{}': Centering window to ({}, {}) on monitor {}.", GET_NAME(), centeredX, centeredY, currentMonitor);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting window mode.", GET_NAME());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting resizable to {}.", GET_NAME(), enabled);
        if (enabled) {
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Minimizing window.", GET_NAME());
        MinimizeWindow();
    }
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Maximizing window.", GET_NAME());
        MaximizeWindow();
    }
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Restoring window.", GET_NAME());
        RestoreWindow();
    }
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Showing window.", GET_NAME());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Hiding window.", GET_NAME());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Requesting focus.", GET_NAME());
        SetWindowFocused();
    }
    ...
    void RaylibWindow::requestAttention()
    {
        ...
        m_logger->trace("RaylibWindow '{}': requestAttention() called but not supported by Raylib.", GET_NAME());
    }
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting opacity to {}.", GET_NAME(), opacity);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting title to '{}'.", GET_NAME(), title);
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting icon from '{}'.", GET_NAME(), filepath.string());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting VSync to {}.", GET_NAME(), enabled);
        if (enabled) {
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting cursor mode.", GET_NAME());
    ...
    {
        HARMONY_CONTEXT_LOGGER_GUARD(m_logger.get());
        m_logger->trace("RaylibWindow '{}': Setting clipboard text.", GET_NAME());
    ...
    HARMONY_REGISTER_EXTENSION(RaylibWindow);
